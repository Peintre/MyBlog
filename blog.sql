...
-- ----------------------------
INSERT INTO `tb_article` VALUES (54, 1, 187, 'https://static.talkxj.com/articles/3dffb2fcbd541886616ab54c92570de3.jpg', '测试文章', '恭喜你成功运行博客，开启你的文章之旅吧。', 1, '', 0, 0, 1, '2022-01-24 23:33:56', '2023-01-01 20:56:15');
INSERT INTO `tb_article` VALUES (66, 1, 187, 'http://localhost:8080/articles/cecf09f5d7bde04a4435d10fc6c60b7c.jpg', '第二篇文章', '啊啊啊啊啊', 1, '', 0, 0, 1, '2022-12-30 19:17:35', NULL);
INSERT INTO `tb_article` VALUES (67, 1, 188, 'http://localhost:8080/articles/81191029fbaf85be7a873b3e93f2af9e.jpg', '3', '3', 1, '', 0, 0, 1, '2022-12-30 19:18:07', NULL);
INSERT INTO `tb_article` VALUES (68, 1, 192, 'http://localhost:8080/articles/754c4b659d53968196eb785dd226ea14.jpg', '4', '4', 1, '', 0, 0, 1, '2022-12-30 19:18:33', NULL);
INSERT INTO `tb_article` VALUES (69, 1, 188, 'http://localhost:8080/articles/cecf09f5d7bde04a4435d10fc6c60b7c.jpg', '5', '5', 1, '', 0, 0, 1, '2022-12-30 19:18:56', NULL);
INSERT INTO `tb_article` VALUES (70, 1, 188, 'http://localhost:8080/articles/81191029fbaf85be7a873b3e93f2af9e.jpg', '这是markdown的测试', '# sdasdasdasd\n1. 这是markdown的测试\n2. **粗体**[这是一个链接](https://www.talkxj.com/articles/1)\n``` java\npublic class PhotoAlbumDTO {\n    /**\n     * 相册id\n     */\n    private Integer id;\n\n    /**\n     * 相册名\n     */\n    private String albumName;\n\n    /**\n     * 相册描述\n     */\n    private String albumDesc;\n\n    /**\n     * 相册封面\n     */\n    private String albumCover;\n\n}\n```', 1, '', 1, 0, 1, '2022-12-30 19:19:24', '2023-01-02 14:12:54');
INSERT INTO `tb_article` VALUES (71, 1, 188, 'http://localhost:8080/articles/69051d80d8ee78591d3c0fc2a4360850.jpg', '啊啊啊啊', '啊实打实大苏打', 1, '', 0, 0, 1, '2023-01-02 14:43:49', '2023-01-02 15:21:15');
INSERT INTO `tb_article` VALUES (72, 1, 187, 'http://localhost:8080/articles/cecf09f5d7bde04a4435d10fc6c60b7c.jpg', '这是一篇测试各种功能的文章', '# 图片\n![description](http://localhost:8080/articles/cecf09f5d7bde04a4435d10fc6c60b7c.jpg){{{width=\"auto\" height=\"auto\"}}}\n# java代码\n``` java\npublic class BizException extends RuntimeException {\n    /**\n     * 错误码\n     */\n    private Integer code = FAIL.getCode();\n    /**\n     * 错误信息\n     */\n    private final String message;\n    public BizException(String message) {\n        this.message = message;\n    }\n    public BizException(StatusCode statusCode) {\n        this.code = statusCode.getCode();\n        this.message = statusCode.getDesc();\n    }\n}\n```\n# 提示信息\n::: tip\n请输入文本\n:::\n::: warning\n请输入文本\n:::\n# emoji\n:grinning::heart_eyes::disappointed:', 1, '', 1, 0, 1, '2023-01-02 19:40:06', '2023-01-02 20:01:51');
...
-- ----------------------------
INSERT INTO `tb_article_tag` VALUES (879, 54, 29);
INSERT INTO `tb_article_tag` VALUES (880, 66, 29);
INSERT INTO `tb_article_tag` VALUES (881, 67, 29);
INSERT INTO `tb_article_tag` VALUES (882, 68, 29);
INSERT INTO `tb_article_tag` VALUES (883, 69, 29);
INSERT INTO `tb_article_tag` VALUES (891, 70, 29);
INSERT INTO `tb_article_tag` VALUES (894, 71, 29);
INSERT INTO `tb_article_tag` VALUES (896, 72, 29);
...
INSERT INTO `tb_category` VALUES (188, '测试分类2', '2022-12-26 20:18:54', NULL);
INSERT INTO `tb_category` VALUES (192, 'aaa', '2022-12-27 11:40:25', NULL);
...
INSERT INTO `tb_friend_link` VALUES (27, '极简壁纸', 'http://localhost:8080/avatar/1bb7964bf0a68036eabb61b58d2c4b79.jpg', 'https://bz.zzzmh.cn/index', '这是一个壁纸网站a', '2022-12-27 16:29:50', '2022-12-27 16:30:02');
...
INSERT INTO `tb_menu` VALUES (7, '修改文章', '/articles/:id', '/article/Article.vue', 'el-icon-myfabiaowenzhang', '2021-01-26 14:31:32', '2022-12-26 17:03:16', 2, 2, 1);
...
INSERT INTO `tb_operation_log` VALUES (1084, '页面模块', '新增或修改', '/admin/pages', 'com.minzheng.blog.controller.PageController.saveOrUpdatePage', '保存或更新页面', '[{\"pageCover\":\"http://你的文件上传子域名/config/bf942a5906a420678ad0273ee33aa4a1.JPG\",\"pageLabel\":\"aa\",\"pageName\":\"aaa\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-11-08 11:26:51', NULL);
INSERT INTO `tb_operation_log` VALUES (1085, '角色模块', '新增或修改', '/admin/role', 'com.minzheng.blog.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":1,\"menuIdList\":[1,2,6,7,8,9,10,3,11,12,202,13,201,213,14,15,16,4,214,209,17,18,205,206,208,210,215,216,217,218,19,20,5,219],\"roleLabel\":\"admin\",\"roleName\":\"管理员\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-11-08 11:33:19', NULL);
INSERT INTO `tb_operation_log` VALUES (1086, '角色模块', '新增或修改', '/admin/role', 'com.minzheng.blog.controller.RoleController.saveOrUpdateRole', '保存或更新角色', '[{\"id\":1,\"resourceIdList\":[165,192,193,194,195,166,183,184,246,247,167,199,200,201,168,185,186,187,188,189,190,191,254,169,208,209,170,234,235,236,237,171,213,214,215,216,217,224,172,240,241,244,245,267,269,270,173,239,242,276,174,205,206,207,175,218,219,220,221,222,223,202,203,230,238,177,229,232,233,243,178,196,197,198,257,258,179,225,226,227,228,231,180,210,211,212,278,282,283,284,285,286,287],\"roleLabel\":\"admin\",\"roleName\":\"管理员\"}]', 'POST', '{\"code\":20000,\"flag\":true,\"message\":\"操作成功\"}', 1, '管理员', '127.0.0.1', '', '2022-11-08 11:34:31', NULL);
...
INSERT INTO `tb_page` VALUES (5, '相册', 'album', 'http://localhost:8080/config/cecf09f5d7bde04a4435d10fc6c60b7c.jpg', '2021-08-07 10:32:36', '2021-12-27 12:23:12');
...
CREATE TABLE `tb_photo`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '照片' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_photo
-- ----------------------------
INSERT INTO `tb_photo` VALUES (41, 17, '1607999847558754310', NULL, 'http://localhost:8080/photos/81191029fbaf85be7a873b3e93f2af9e.jpg', 0, '2022-12-28 15:20:14', '2022-12-28 22:50:08');
INSERT INTO `tb_photo` VALUES (48, 17, '1608000098537517059', NULL, 'http://localhost:8080/photos/0c8b95e08db3c0d2fa8b4e1b7af244e6.jpg', 0, '2022-12-28 15:21:13', '2022-12-28 22:51:40');
INSERT INTO `tb_photo` VALUES (49, 22, '1608049119633268738', 'sss', 'http://localhost:8080/photos/754c4b659d53968196eb785dd226ea14.jpg', 0, '2022-12-28 18:36:01', '2022-12-28 22:47:02');
INSERT INTO `tb_photo` VALUES (51, 21, '1608101731216875523', NULL, 'http://localhost:8080/photos/0c8b95e08db3c0d2fa8b4e1b7af244e6.jpg', 0, '2022-12-28 22:05:04', '2022-12-28 22:49:51');
...
CREATE TABLE `tb_photo_album`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '相册' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_photo_album
-- ----------------------------
INSERT INTO `tb_photo_album` VALUES (17, 'ccc', 'ccc', 'http://localhost:8080/photos/cecf09f5d7bde04a4435d10fc6c60b7c.jpg', 0, 1, '2022-12-27 21:22:10', '2022-12-28 22:51:41');
INSERT INTO `tb_photo_album` VALUES (21, 'ssssss', 'ss', 'http://localhost:8080/photos/4033a160c3881924d8dfb201bd973064.jpg', 0, 1, '2022-12-28 18:45:45', NULL);
INSERT INTO `tb_photo_album` VALUES (22, 'aaaaaaaaaaaaa', 'ss', 'http://localhost:8080/photos/69051d80d8ee78591d3c0fc2a4360850.jpg', 0, 1, '2022-12-28 18:45:53', '2022-12-28 22:47:02');
INSERT INTO `tb_photo_album` VALUES (25, '相册1', '相册1描述', 'http://localhost:8080/photos/754c4b659d53968196eb785dd226ea14.jpg', 0, 1, '2023-01-01 14:39:08', NULL);
INSERT INTO `tb_photo_album` VALUES (26, '相册2', '相册2描述', 'http://localhost:8080/photos/cecf09f5d7bde04a4435d10fc6c60b7c.jpg', 0, 1, '2023-01-01 14:39:24', NULL);
...
-- ----------------------------
INSERT INTO `tb_resource` VALUES (165, '分类模块', NULL, NULL, NULL, 0, '2021-08-11 21:04:21', '2022-12-11 16:41:00');
...
INSERT INTO `tb_resource` VALUES (192, '查看后台分类列表', '/admin/categories', 'GET', 165, 0, '2021-08-11 21:04:22', '2022-12-11 16:40:34');
...
INSERT INTO `tb_resource` VALUES (202, '根据条件查询菜单', '/menu/getMenusList', 'GET', 176, 0, '2021-08-11 21:04:22', '2022-12-15 17:42:26');
INSERT INTO `tb_resource` VALUES (203, '新增/修改菜单', '/menu/saveOrUpdateMenu', 'POST', 176, 0, '2021-08-11 21:04:22', '2022-12-15 17:34:39');
INSERT INTO `tb_resource` VALUES (204, '删除菜单', '/menu/deleteMenu/*', 'DELETE', 176, 0, '2021-08-11 21:04:22', '2022-12-12 09:36:50');
...
INSERT INTO `tb_resource` VALUES (226, '新增/修改资源', '/resource/saveOrUpdateResource', 'POST', 179, 0, '2021-08-11 21:04:22', '2022-12-17 17:17:35');
INSERT INTO `tb_resource` VALUES (228, '删除资源权限', '/resource/deleteResource/*', 'DELETE', 179, 0, '2021-08-11 21:04:22', '2022-12-17 17:18:04');
INSERT INTO `tb_resource` VALUES (230, '查看所有菜单信息', '/menu/getAllMenus', 'GET', 176, 0, '2021-08-11 21:04:22', '2022-12-17 17:15:22');
INSERT INTO `tb_resource` VALUES (231, '查看资源权限列表', '/resource/getAllResourcesList', 'GET', 179, 0, '2021-08-11 21:04:22', '2022-12-17 17:39:32');
INSERT INTO `tb_resource` VALUES (232, '根据条件查询角色', '/role/getAllRoles', 'GET', 177, 0, '2021-08-11 21:04:22', '2022-12-15 17:45:18');
INSERT INTO `tb_resource` VALUES (233, '删除角色基本信息', '/role/deleteRoles', 'DELETE', 177, 0, '2021-08-11 21:04:22', '2022-12-17 17:50:58');
...
INSERT INTO `tb_resource` VALUES (238, '查看当前用户菜单', '/menu/getUserMenus', 'GET', 176, 0, '2021-08-11 21:04:22', '2022-12-15 17:27:53');
INSERT INTO `tb_resource` VALUES (242, '修改管理员密码', '/userAuth/updateAdminPwd', 'PUT', 173, 0, '2021-08-11 21:04:22', '2022-12-17 18:00:39');
INSERT INTO `tb_resource` VALUES (243, '查询用户角色信息', '/role/getUserRoles', 'GET', 177, 0, '2021-08-11 21:04:22', '2022-12-15 17:48:01');
...
INSERT INTO `tb_resource` VALUES (267, '更新用户头像', '/userInfo/avatar', 'POST', 172, 0, '2021-08-11 21:04:22', '2022-12-17 18:03:14');
INSERT INTO `tb_resource` VALUES (270, '更新用户信息', '/userInfo/updateUserInfo', 'PUT', 172, 0, '2021-08-11 21:04:22', '2022-12-17 18:03:48');
...
INSERT INTO `tb_resource` VALUES (292, '修改角色信息', '/role/updateRoleMenuResource', 'POST', 177, 0, '2022-12-15 17:49:48', '2022-12-17 17:52:43');
INSERT INTO `tb_resource` VALUES (294, '查看所有资源权限', '/resource/getAllResources', 'GET', 179, 0, '2022-12-17 17:47:20', NULL);
INSERT INTO `tb_resource` VALUES (295, '新增角色基本信息', '/role/addRole', 'POST', 177, 0, '2022-12-17 17:51:46', '2022-12-17 17:52:34');
INSERT INTO `tb_resource` VALUES (296, '修改角色基本信息', '/role/updateRole', 'POST', 177, 0, '2022-12-17 17:53:14', NULL);
...
-- Records of tb_role
-- ----------------------------
INSERT INTO `tb_role` VALUES (1, '管理员', 'admin', 0, '2021-03-22 14:10:21', '2022-12-06 22:28:52');
...
CREATE TABLE `tb_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2984 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_role_menu` VALUES (2951, 1, 1);
INSERT INTO `tb_role_menu` VALUES (2952, 1, 2);
INSERT INTO `tb_role_menu` VALUES (2953, 1, 6);
INSERT INTO `tb_role_menu` VALUES (2954, 1, 7);
INSERT INTO `tb_role_menu` VALUES (2955, 1, 8);
INSERT INTO `tb_role_menu` VALUES (2956, 1, 9);
INSERT INTO `tb_role_menu` VALUES (2957, 1, 10);
INSERT INTO `tb_role_menu` VALUES (2958, 1, 3);
INSERT INTO `tb_role_menu` VALUES (2959, 1, 11);
INSERT INTO `tb_role_menu` VALUES (2960, 1, 12);
INSERT INTO `tb_role_menu` VALUES (2961, 1, 202);
INSERT INTO `tb_role_menu` VALUES (2962, 1, 13);
INSERT INTO `tb_role_menu` VALUES (2963, 1, 201);
INSERT INTO `tb_role_menu` VALUES (2964, 1, 213);
INSERT INTO `tb_role_menu` VALUES (2965, 1, 14);
INSERT INTO `tb_role_menu` VALUES (2966, 1, 15);
INSERT INTO `tb_role_menu` VALUES (2967, 1, 16);
INSERT INTO `tb_role_menu` VALUES (2968, 1, 4);
INSERT INTO `tb_role_menu` VALUES (2969, 1, 214);
INSERT INTO `tb_role_menu` VALUES (2970, 1, 209);
INSERT INTO `tb_role_menu` VALUES (2971, 1, 17);
INSERT INTO `tb_role_menu` VALUES (2972, 1, 18);
INSERT INTO `tb_role_menu` VALUES (2973, 1, 205);
INSERT INTO `tb_role_menu` VALUES (2974, 1, 206);
INSERT INTO `tb_role_menu` VALUES (2975, 1, 208);
INSERT INTO `tb_role_menu` VALUES (2976, 1, 210);
INSERT INTO `tb_role_menu` VALUES (2977, 1, 215);
INSERT INTO `tb_role_menu` VALUES (2978, 1, 216);
INSERT INTO `tb_role_menu` VALUES (2979, 1, 217);
INSERT INTO `tb_role_menu` VALUES (2980, 1, 218);
INSERT INTO `tb_role_menu` VALUES (2981, 1, 19);
INSERT INTO `tb_role_menu` VALUES (2982, 1, 20);
INSERT INTO `tb_role_menu` VALUES (2983, 1, 5);
INSERT INTO `tb_role_menu` VALUES (2984, 2, 1);
...
CREATE TABLE `tb_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5795 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_role_resource
-- ----------------------------
INSERT INTO `tb_role_resource` VALUES (4750, 14, 238);
INSERT INTO `tb_role_resource` VALUES (5706, 1, 165);
INSERT INTO `tb_role_resource` VALUES (5707, 1, 192);
INSERT INTO `tb_role_resource` VALUES (5708, 1, 193);
INSERT INTO `tb_role_resource` VALUES (5709, 1, 194);
INSERT INTO `tb_role_resource` VALUES (5710, 1, 195);
INSERT INTO `tb_role_resource` VALUES (5711, 1, 166);
INSERT INTO `tb_role_resource` VALUES (5712, 1, 183);
INSERT INTO `tb_role_resource` VALUES (5713, 1, 184);
INSERT INTO `tb_role_resource` VALUES (5714, 1, 246);
INSERT INTO `tb_role_resource` VALUES (5715, 1, 247);
INSERT INTO `tb_role_resource` VALUES (5716, 1, 167);
INSERT INTO `tb_role_resource` VALUES (5717, 1, 199);
INSERT INTO `tb_role_resource` VALUES (5718, 1, 200);
INSERT INTO `tb_role_resource` VALUES (5719, 1, 201);
INSERT INTO `tb_role_resource` VALUES (5720, 1, 168);
INSERT INTO `tb_role_resource` VALUES (5721, 1, 185);
INSERT INTO `tb_role_resource` VALUES (5722, 1, 186);
INSERT INTO `tb_role_resource` VALUES (5723, 1, 187);
INSERT INTO `tb_role_resource` VALUES (5724, 1, 188);
INSERT INTO `tb_role_resource` VALUES (5725, 1, 189);
INSERT INTO `tb_role_resource` VALUES (5726, 1, 190);
INSERT INTO `tb_role_resource` VALUES (5727, 1, 191);
INSERT INTO `tb_role_resource` VALUES (5728, 1, 254);
INSERT INTO `tb_role_resource` VALUES (5729, 1, 169);
INSERT INTO `tb_role_resource` VALUES (5730, 1, 208);
INSERT INTO `tb_role_resource` VALUES (5731, 1, 209);
INSERT INTO `tb_role_resource` VALUES (5732, 1, 170);
INSERT INTO `tb_role_resource` VALUES (5733, 1, 234);
INSERT INTO `tb_role_resource` VALUES (5734, 1, 235);
INSERT INTO `tb_role_resource` VALUES (5735, 1, 236);
INSERT INTO `tb_role_resource` VALUES (5736, 1, 237);
INSERT INTO `tb_role_resource` VALUES (5737, 1, 171);
INSERT INTO `tb_role_resource` VALUES (5738, 1, 213);
INSERT INTO `tb_role_resource` VALUES (5739, 1, 214);
INSERT INTO `tb_role_resource` VALUES (5740, 1, 215);
INSERT INTO `tb_role_resource` VALUES (5741, 1, 216);
INSERT INTO `tb_role_resource` VALUES (5742, 1, 217);
INSERT INTO `tb_role_resource` VALUES (5743, 1, 224);
INSERT INTO `tb_role_resource` VALUES (5744, 1, 172);
INSERT INTO `tb_role_resource` VALUES (5745, 1, 267);
INSERT INTO `tb_role_resource` VALUES (5746, 1, 270);
INSERT INTO `tb_role_resource` VALUES (5747, 1, 173);
INSERT INTO `tb_role_resource` VALUES (5748, 1, 242);
INSERT INTO `tb_role_resource` VALUES (5749, 1, 174);
INSERT INTO `tb_role_resource` VALUES (5750, 1, 205);
INSERT INTO `tb_role_resource` VALUES (5751, 1, 206);
INSERT INTO `tb_role_resource` VALUES (5752, 1, 207);
INSERT INTO `tb_role_resource` VALUES (5753, 1, 175);
INSERT INTO `tb_role_resource` VALUES (5754, 1, 218);
INSERT INTO `tb_role_resource` VALUES (5755, 1, 219);
INSERT INTO `tb_role_resource` VALUES (5756, 1, 220);
INSERT INTO `tb_role_resource` VALUES (5757, 1, 221);
INSERT INTO `tb_role_resource` VALUES (5758, 1, 222);
INSERT INTO `tb_role_resource` VALUES (5759, 1, 223);
INSERT INTO `tb_role_resource` VALUES (5760, 1, 176);
INSERT INTO `tb_role_resource` VALUES (5761, 1, 202);
INSERT INTO `tb_role_resource` VALUES (5762, 1, 203);
INSERT INTO `tb_role_resource` VALUES (5763, 1, 204);
INSERT INTO `tb_role_resource` VALUES (5764, 1, 230);
INSERT INTO `tb_role_resource` VALUES (5765, 1, 238);
INSERT INTO `tb_role_resource` VALUES (5766, 1, 177);
INSERT INTO `tb_role_resource` VALUES (5767, 1, 232);
INSERT INTO `tb_role_resource` VALUES (5768, 1, 233);
INSERT INTO `tb_role_resource` VALUES (5769, 1, 243);
INSERT INTO `tb_role_resource` VALUES (5770, 1, 292);
INSERT INTO `tb_role_resource` VALUES (5771, 1, 295);
INSERT INTO `tb_role_resource` VALUES (5772, 1, 296);
INSERT INTO `tb_role_resource` VALUES (5773, 1, 178);
INSERT INTO `tb_role_resource` VALUES (5774, 1, 196);
INSERT INTO `tb_role_resource` VALUES (5775, 1, 197);
INSERT INTO `tb_role_resource` VALUES (5776, 1, 198);
INSERT INTO `tb_role_resource` VALUES (5777, 1, 257);
INSERT INTO `tb_role_resource` VALUES (5778, 1, 258);
INSERT INTO `tb_role_resource` VALUES (5779, 1, 179);
INSERT INTO `tb_role_resource` VALUES (5780, 1, 226);
INSERT INTO `tb_role_resource` VALUES (5781, 1, 228);
INSERT INTO `tb_role_resource` VALUES (5782, 1, 231);
INSERT INTO `tb_role_resource` VALUES (5783, 1, 294);
INSERT INTO `tb_role_resource` VALUES (5784, 1, 180);
INSERT INTO `tb_role_resource` VALUES (5785, 1, 210);
INSERT INTO `tb_role_resource` VALUES (5786, 1, 211);
INSERT INTO `tb_role_resource` VALUES (5787, 1, 212);
INSERT INTO `tb_role_resource` VALUES (5788, 1, 278);
INSERT INTO `tb_role_resource` VALUES (5789, 1, 282);
INSERT INTO `tb_role_resource` VALUES (5790, 1, 283);
INSERT INTO `tb_role_resource` VALUES (5791, 1, 284);
INSERT INTO `tb_role_resource` VALUES (5792, 1, 285);
INSERT INTO `tb_role_resource` VALUES (5793, 1, 286);
INSERT INTO `tb_role_resource` VALUES (5794, 1, 287);
...
INSERT INTO `tb_talk` VALUES (51, 1, '这是一次说说测试<img src=\"https://static.talkxj.com/emoji/smile.jpg\" width=\"24\" height=\"24\" alt=\"[微笑]\" style=\"margin: 0 1px;vertical-align: text-bottom\">(编辑）\n', '[\"http://localhost:8080/talks/cecf09f5d7bde04a4435d10fc6c60b7c.jpg\"]', 0, 1, '2022-12-29 16:59:58', '2022-12-29 17:54:27');
...
-- ----------------------------
INSERT INTO `tb_user_auth` VALUES (1, 1, 'admin@qq.com', '$2a$10$2j7FNGAnjk8iw0UPNvGwQuPeT.HpBZvqSy5KDFuCMVVdMVejDiDfm', 1, '192.168.221.80', '本地局域网', '2021-08-12 15:43:18', '2023-01-04 22:04:52', '2023-01-04 22:04:52');
INSERT INTO `tb_user_auth` VALUES (995, 1005, 'test@qq.com', '$2a$10$2j7FNGAnjk8iw0UPNvGwQuPeT.HpBZvqSy5KDFuCMVVdMVejDiDfm', 1, '192.168.221.80', '本地局域网', '2022-01-27 10:58:11', '2023-01-05 11:33:02', '2023-01-05 11:33:02');
INSERT INTO `tb_user_auth` VALUES (996, 1007, '1252557285@qq.com', '$2a$10$nbNj.68qNdfAkmMhI0dKvO7qtbSuzWKY.blTyGubxJUsgKMyEMNLq', 1, '192.168.221.80', '本地局域网', '2023-01-06 18:05:45', '2023-01-07 19:06:08', '2023-01-07 19:06:08');
...
-- ----------------------------
INSERT INTO `tb_user_info` VALUES (1, 'admin@qq.com', '管理员', 'http://localhost:8080/avatar/1bb7964bf0a68036eabb61b58d2c4b79.jpg', '这是个人简介s', 'aaaaaa', 0, '2021-08-12 15:43:17', '2022-12-27 14:23:27');
INSERT INTO `tb_user_info` VALUES (1005, 'xiaainy@163.com', '测试用户', 'https://static.talkxj.com/config/2cd793c8744199053323546875655f32.jpg', '这是个人简介', NULL, 0, '2022-01-27 10:58:11', '2022-12-18 14:10:56');
INSERT INTO `tb_user_info` VALUES (1007, '1252557285@qq.com', '用户1611302994041556994', 'http://localhost:8080/config/0c8b95e08db3c0d2fa8b4e1b7af244e6.jpg', NULL, NULL, 0, '2023-01-06 18:05:45', NULL);
...
INSERT INTO `tb_user_role` VALUES (1003, 1005, 3);
INSERT INTO `tb_user_role` VALUES (1005, 1007, 2);
...
-- ----------------------------
INSERT INTO `tb_website_config` VALUES (1, '{\"alipayQRCode\":\"https://static.talkxj.com/photos/13d83d77cc1f7e4e0437d7feaf56879f.png\",\"articleCover\":\"http://localhost:8080/config/cecf09f5d7bde04a4435d10fc6c60b7c.jpg\",\"gitee\":\"https://gitee.com/Peintrey\",\"github\":\"https://github.com/Peintre\",\"isChatRoom\":1,\"isCommentReview\":0,\"isEmailNotice\":1,\"isMessageReview\":0,\"isMusicPlayer\":1,\"isReward\":1,\"qq\":\"1252557285\",\"socialLoginList\":[\"qq\",\"weibo\"],\"socialUrlList\":[\"qq\",\"github\",\"gitee\"],\"touristAvatar\":\"http://localhost:8080/config/c876dd98a40d8cba767cad189244165e.jpg\",\"userAvatar\":\"http://localhost:8080/config/0c8b95e08db3c0d2fa8b4e1b7af244e6.jpg\",\"websiteAuthor\":\"Peintre丶\",\"websiteAvatar\":\"http://localhost:8080/config/1bb7964bf0a68036eabb61b58d2c4b79.jpg\",\"websiteCreateTime\":\"2021-11-18\",\"websiteIntro\":\"风流至死，不枉少年！\",\"websiteName\":\"Peintre\",\"websiteNotice\":\"请前往后台管理->系统管理->网站管理处修改信息\",\"websiteRecordNo\":\"暂无备案号\",\"websocketUrl\":\"ws://127.0.0.1:8080/websocket\",\"weiXinQRCode\":\"https://static.talkxj.com/photos/4f767ef84e55ab9ad42b2d20e51deca1.png\"}', '2021-08-09 19:37:30', '2022-01-18 00:25:47');
