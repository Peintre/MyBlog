...
import static com.peintre.utils.PageUtils.getLimitCurrent;
import static com.peintre.utils.PageUtils.getSize;

/**
 * @Program: MyBlog
 * @Description: (tb_user_info)表服务实现类
 * @Author: Peintre
...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoDao, UserInfo> implements UserInfoService {
    ...
    @Override
    public PageResultVo<UserOnlineDTO> listOnlineUsers(ConditionVo conditionVo) {
        // 获取security在线session
        ...
        return new PageResultVo<>(userOnlineList, userOnlineDTOList.size());
    }
}
